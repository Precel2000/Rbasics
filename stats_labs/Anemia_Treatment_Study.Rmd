...
rbccF <- function(n){
  #1st measurement
  m_1 <- rnorm(n, 133, 5)+ rnorm(n,0,2)
  #2nd measurement
  m_2 <- rnorm(n, 133, 5)+ rnorm(n,0,2)
  m <-cbind(m_1, m_2)
  return(m)
}
```
...
```{r}
rbccM <- function(n){
  m_1 <- rnorm(n, 150, 6)+ rnorm(n,0,2)
  m_2 <- rnorm(n, 150, 6)+ rnorm(n,0,2)
  m <-cbind(m_1, m_2)
  return(m)
}
```
...
points(B[1001:2000,1], B[1001:2000,2], col="black")
points(B1[,1], B1[,2], col="red")
abline(46.2743, 0.6739)
abline(51.1323,0.4956, col="red")
```
